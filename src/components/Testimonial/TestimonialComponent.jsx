    ...
    <section className="container-fluid py-5">
      ...
      <div className="justify-content-center">
        <div className="row overflow-hidden">
          <div className=" shadow bg-testimonial first col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
            ...
            <img
              ...
              width="60"
            />
            <p className="testimonial-text mt-3 paragraf-max">
          ...
          <div className=" shadow bg-testimonial middle col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
          ...
          <div className="shadow bg-testimonial last col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
